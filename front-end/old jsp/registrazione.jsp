...
<style><%@include file="/resources/CSS/registrazioneStyle.css"%></style>
</head>
<body>
	<div class="contenitore">
		...
		<div class="homePage">
			...
			<form:form modelAttribute="getUtente" action="RegistrazioneServlet" method="post">
				<div class="login">
					<div class="contenitoreAvatar">
						<img src="${pageContext.request.contextPath}/resources/IMG/avatar.png" alt="Avatar" class="avatar">
					</div>
					<div class="mb-3">
						<label for="exampleInputEmail1" class="form-label">Nome:</label> <form:input path="nome" cssClass="form-control" placeholder="Nome"/>
							<form:errors path="nome" cssClass="error"/>

					</div>
					<div class="mb-3">
						<label for="exampleInputEmail1" class="form-label">Cognome:</label>
						<form:input path="cognome" cssClass="form-control" placeholder="Cognome"/>
					...
					<div class="mb-3">
						...
						<form:input path="password" cssClass="form-control" type = "password" placeholder="Password"/>
							...
							<small id="infoPassword"
							class="form-text text-muted">* La password deve essere
							lunga 8 caratteri e deve contenere almeno una lettera minuscola,
							una maiuscola, un numero e un carattere speciale(#*@%)</small>
					</div>
					...
					<div>
						...
						<div class="text-center  font-weight-bold font-italic">
							<h5
								...
								Registrazione avvenuta con successo</h5>
						</div>
						<div class="text-center col-md-12 font-weight-bold font-italic">
							<h5 style="color:red; display: ${datiErrati ? 'block' : 'none'}">
								Dati Errati riprovare</h5>
						</div>
