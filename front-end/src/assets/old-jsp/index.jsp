...
<body>
	...
	<div class="contenitore">
		...
		<div class="homePage">
			...
			<form:form modelAttribute="getUtente" action="LoginServlet" method="post">
				<div class="login">
					...
					<button type="submit" class="btn btn-success w-100 mb-3">Accedi</button>

					 <a href="registrazione"
						   class="btn buttonRegistrati w-100" >Registrati</a>
					<div>
						<div class="text-center  font-weight-bold font-italic">
						
							<h5
								style="color:red; display: ${utenteNonRegistrato ? 'block' : 'none'}">
								Utente non registrato</h5>
						</div>
						<div class="text-center  font-weight-bold font-italic">
							<h5
								style="color:black; display: ${registrazioneEseguita ? 'block' : 'none'}">
